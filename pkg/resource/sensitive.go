...
//
//go:generate go run github.com/golang/mock/mockgen -copyright_file ../../hack/boilerplate.txt -destination ./fake/mocks/mock.go -package mocks github.com/HolyBitsLLC/upjet/v2/pkg/resource SecretClient
